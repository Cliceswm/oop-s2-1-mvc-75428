...
namespace Library.MVC.Controllers
{
    public class LoansController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            // Count how many loans are overdue
            // Overdue = DueDate < Today AND ReturnedDate == null
            var overdueCount = loans.Count(l => l.DueDate < DateTime.Now && l.ReturnedDate == null);
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,MemberId,LoanDate,DueDate,ReturnedDate")] Loan loan)
        {
            ...
            if (activeLoan != null)
            {
                ModelState.AddModelError("", "Book is already on loan.");
